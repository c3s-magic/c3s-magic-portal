...
rm ${SECURITY_CONTROLLER}/keystore.jks
...
sudo keytool -import -v -trustcacerts -alias letsencryptca -file /etc/letsencrypt/live/$HOSTNAME/chain.pem -keystore ${SECURITY_CONTROLLER}/truststore.ts -storepass changeit -noprompt
