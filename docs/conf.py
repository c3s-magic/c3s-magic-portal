...
man_pages = [
    (master_doc, 'c3smagic', 'C3S Magic Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'C3SMagic', 'C3S Magic Documentation',
     author, 'C3SMagic', 'One line description of project.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {'esmvaltool': ('https://esmvaltool.readthedocs.io/en/v2.0a2', None)}
